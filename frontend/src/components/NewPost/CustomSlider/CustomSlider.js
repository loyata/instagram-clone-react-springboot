...
import blank from "./img.png"

const CustomSlider = ({adjName, adjValues, setAdjValues}) => {
            ...
            <div className="slider_total">
                <div className="slider_container">
                    <div className="slider_container2" ref={containerRef}>
                        <div className="slider_container2_left">
                            <div className="slider_container2_left_left">
                                <div className="slider_hr"/>
                            </div>
                            <div className="slider_container2_left_right" style={{width:`${widthLeft}px`}}>
                        ...
                        <div className="slider_ball"
                             ...
                             onDrag={(event)=>{
                                 if(event.clientX !== 0){
                                     ...
                                     const maxMove = containerRef.current.offsetWidth / 2 - ballRef.current.offsetWidth / 2;
